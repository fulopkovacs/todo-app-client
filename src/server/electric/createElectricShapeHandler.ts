...
export type ElectricTableName = "boards" | "projects" | "todo_items";

export function createElectricShapeHandler(table: ElectricTableName) {
  return async function electricShapeHandler({
    request,
  }: {
    request: Request;
  }) {
